...
`;
    ...
    const expectedTokens = [
      ...
      { type: "STRING", value: "Hello, ", line: 3, column: 8 },
      { type: "INTERPOLATION_START", value: "#{ ", line: 3, column: 15 },
      { type: "AT_SIGN", value: "@", line: 3, column: 17 },
      { type: "IDENTIFIER", value: "player_name", line: 3, column: 18 },
      { type: "INTERPOLATION_END", value: "}", line: 3, column: 29 },
      { type: "STRING", value: "!", line: 3, column: 30 },
      { type: "NEWLINE", value: "\n", line: 3, column: 32 },
      ...
      { type: "STRING", value: "Continue", line: 6, column: 11 },
      ...
      { type: "STRING", value: "Shop", line: 7, column: 11 },
